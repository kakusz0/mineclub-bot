...
//        Role role = new RoleImpl(943456468169023488L, member.getGuild());
//        if (!member.getRoles().contains(role)) {
//            event.reply("Nigga nie mozesz").queue(message -> message.deleteOriginal().queueAfter(5, TimeUnit.SECONDS));
//            return;
//        }
